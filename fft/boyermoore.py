'''
Nov 15 2015
Boyer Moore implementation, from
https://github.com/BenLangmead/comp-genomics-class/blob/master/notebooks/CG_BoyerMoore.ipynb

Includes a wrapper for boyer_moore() that follows the same function interface
from fftmatch.py

def boyer_moore_match_index(text, pattern)
'''
...
def boyer_moore_match_index(text, pattern):
    '''Wrapper for Boyer Moore that uses the same interface as the other
...
if __name__ == "__main__":
    ...
    print t[9:9+len(p)]  # confirm it really occurs
    print boyer_moore(p, p_bm, 'needleneedleneedle')
